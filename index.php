...
<html>
	...
	<body style="background: #f2f2f2;">
		...
		<ul>
			...
			<li><a href="admin_login.php">管理者登录</a></li>
			<li><a href="user_login.php">用户登录</a></li>
			<li><a href="#rooms_and_rates">房间一览</a></li>
			<li><a href="image_gallery.php">设施一览</a>
			<li style="float: right;"><a href="#contact">联系我们</a></li>
		</ul>
		...
		<div class="mySlides fade">
		  ...
		  <div class="text">享受不一般的酒店体验</div>
		</div>

		<div class="mySlides fade">
		  <img id="2" src="Images/2.jpg" style="width:100%">
		  <div class="text">重新定义奢华</div>
		</div>

		<div class="mySlides fade">
		  <img id="3" src="Images/3.jpg" style="width:100%">
		  <div class="text">品味每一份餐点，每一项服务</div>
		</div>
		...
		<br><br>
		<a class="reserve_room" href="user_login.php">点此预订</a><br>

		<h2 class="welcome1">享受愉快的住宿体验，尽享精彩优惠</h2><br>
		<h2 class="welcome2">找到我们宾至如归的前台</h2><br>

		<h2 class="r_room">我们的房间</h2><br>
		...
		<div id="contact" class="footer">
			<hr>
			<h2 class="foot-text">联系我们！</h2>
			<h3 class="foot-text">开发者: 丁倩怡</h3><br>
		</div>
	</body>
</html>