	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
			<table class="basic_box">
				<tr>
					<td colspan="6"><p style="font-size: 28px; text-align: center; text-decoration: underline;"><b>管理房间状态</b></p>
				</td>
				<tr>
					<th>订单编号</th>
					<th>姓名</th>
			...
			<table class="basic_box">
				...
				<tr>
					<td></td>
					<td style="text-align: center;"><button type="submit">确认</button>
  					<button type="submit" formaction="cancel_room.php">驳回预订请求</button></td></form>	
				</tr>
			</table>
		</div>
	</body>
