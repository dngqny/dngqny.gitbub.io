...
<body>
	...
	<ul>
		...
		<li><a href="confirmed_bookings.php">确认预订</a></li>
	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		...
		<?php
			...
			<div class="basic_box">
		  	<table>
				<tr>
					<th colspan="4"><p style="font-size: 28px; text-align: center; text-decoration: underline;">添加房间</p></th>
				</tr>
				<tr>
					<th>房间类型</th>
					<th>可预订房间数量</th>
			...
			<table>
				<tr>
					<td style="text-align: left;"><b>选择房间类型:</td>
					<td style="text-align: left;">
						<select name="rooms" required>
							<option value="">选择</option>
							<option value="Single bed">单床房</option>
							<option value="Double bed">双床房</option>
							<option value="Four bed">大床房</option>
						</select>
					</td>
				</tr>
				<tr>
					<td style="text-align: left;">请输入添加的房间数量:</td>
